...
if (isset($_POST['flat_ads_id'])) {
	$ads_id = $_POST['flat_ads_id'];
	$sql = "SELECT * from flat where ads_id = '$ads_id';";
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		<div class="left_section_information">
			<table class="left_section_table">
				...
				<tr>
					<td align="right" class="label"><span>Size : </span></td>
					<td align="left" class="show_data"><span><?php echo $row['size']; ?></span></td>
				</tr>
				<tr>
					<td align="right" class="label"><span>No. of Bedroom : </span></td>
					<td align="left" class="show_data"><span><?php echo $row['bedroom']; ?></span></td>
				</tr>
				<tr>
					<td align="right" class="label"><span>No. of Corridor : </span></td>
					<td align="left" class="show_data"><span><?php echo $row['corridor']; ?></span></td>
				</tr>
				<tr>
					<td align="right" class="label"><span>No. of Bathroom : </span></td>
					<td align="left" class="show_data"><span><?php echo $row['bathroom']; ?></span></td>
				</tr>
				<tr>
					<td align="right" class="label"><span>Special Facility : </span></td>
					<td align="left" class="show_data"><span><?php echo $row['facility']; ?></span></td>
				</tr>
				<tr>
   ...
   function approveButtonClicked(event) {
    ...
    $('#load_details').load('../includes/load_admin_flat_verify_details.inc.php', {
    ...
    document.getElementById("verified_btn").click();
				...
				// $('#left_section_information').load('../includes/load_admin_flat_verify_details.inc.php', {
    //  'flat_ads_id': buttonValue
    // });
   }
   ...
   function leftDeleteButtonClicked(event) {
	...
	<?php
		...
		if ($button_value == "All") {
			...
			$sql = "SELECT * FROM flat WHERE status = 'verified' AND state = 'active';";
			$result = mysqli_query($conn, $sql);
		} else if($button_value == "Unverified"){
			$sql = "SELECT * FROM flat WHERE status = 'unverified' AND state = 'active';";
			$result = mysqli_query($conn, $sql);
		} else if($button_value == "Deleted"){
			$sql = "SELECT * FROM flat WHERE state = 'deactive';";
			$result = mysqli_query($conn, $sql);
		}
		?>
