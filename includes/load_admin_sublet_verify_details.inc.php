...
if (isset($_POST['sublet_ads_id'])) {
	$ads_id = $_POST['sublet_ads_id'];
	$sql = "SELECT * from sublet where ads_id = '$ads_id';";
   ...
   function approveButtonClicked(event) {
    ...
    $('#load_details').load('../includes/load_admin_sublet_verify_details.inc.php', {
    ...
    document.getElementById("verified_btn").click();
				...
				// $('#left_section_information').load('../includes/load_admin_sublet_verify_details.inc.php', {
    //  'sublet_ads_id': buttonValue
    // });
   }
   ...
   function leftDeleteButtonClicked(event) {
	...
	<?php
		...
		if ($button_value == "All") {
			...
			$sql = "SELECT * FROM sublet WHERE status = 'verified' AND state = 'active';";
			$result = mysqli_query($conn, $sql);
		} else if($button_value == "Unverified"){
			$sql = "SELECT * FROM sublet WHERE status = 'unverified' AND state = 'active';";
			$result = mysqli_query($conn, $sql);
		} else if($button_value == "Deleted"){
			$sql = "SELECT * FROM sublet WHERE state = 'deactive';";
			$result = mysqli_query($conn, $sql);
		}
		?>
