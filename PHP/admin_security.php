...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 if (isset($_POST['pass_change_button'])) {
  ...
  if ($err1 == "" && $err2 == "" && $err3 == "") {
   $sqlUserCheck = "SELECT password FROM admin WHERE username = '$username' and state = 'active';";
   ...
   if (password_verify($old_pass, $user_DB_pass)) {
    if ($new_pass == $confirm_new_pass) {
     ...
     $sql = "UPDATE admin SET password='$user_passwordToDB' WHERE username = '$username';";
