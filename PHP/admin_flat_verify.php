...
<head>
 ...
 <title>Flat Verify</title>
</head>

<body>
 <?php echo after_login_admin_header("veirfy"); ?>

 <section class="flat_verify_section">
  <div class="container">
 ...
 <script>
  $(document).ready(function () {
   ...
   function viewAllDetails(event) {
    ...
    $('#right_section_information').load('../includes/load_admin_flat_verify_details.inc.php', {
     'btn_click': allButtonValue
    });

    $('#left_section').load('../includes/load_admin_flat_verify_details.inc.php', {
