...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if (isset($_POST['pass_change_button'])) {
		...
		if ($err1 == "" && $err2 == "" && $err3 == "") {
			$sqlUserCheck = "SELECT password FROM owner WHERE username = '$username' and state = 'active';";
			...
			if (password_verify($old_pass, $user_DB_pass)) {
				if ($new_pass == $confirm_new_pass) {
					...
					$sql = "UPDATE owner SET password='$user_passwordToDB' WHERE username = '$username';";
				...
				<nav id="header_nav">
					<ul>
						<span id="header_nav_list">
							<li>
								<a href="owner_homepage.php">Home</a>
							</li>
							<li id="separator"><b>|</b></li>
							<li>
								<a href="my_advertise.php">My Ads</a>
							</li>
							<li id="separator"><b>|</b></li>
							<li class="current">
								<a href="owner_profile.php">Dashboard</a>
							</li>
						</span>
