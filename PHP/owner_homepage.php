...
<body>
	<?php echo after_login_owner_header("home"); ?>
	...
	<section id="categories">
		<div class="container">
			...
			<div class="category">
				<p id="post_ads">Post Ads in Your Desired Category</p>
				<div>
					<ul>
						<li>
							<form action="owner_flat_ads.php" method="GET">
        ...
        <a href="owner_flat_ads.php">
         <label for="flat_icon" class="ad_icon_label">FLAT</label>
						...
						<li>
							<form action="owner_mess_ads.php" method="GET">
        ...
        <label for="mess_icon" class="ad_icon_label">MESS</label> -->
						...
						<li>
							<form action="owner_sublet_ads.php" method="GET">
