...
if ($user_status == "unverified") {
	echo unverified_modal("show_flat_ads.php");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (isset($_POST['apply_filter_btn'])) {
		...
		if ($search_title == "" && $search_area == "all" && $min_rent == "" && $max_rent == "") {
			...
			$query = "SELECT * FROM all_ads WHERE ads_type = '$ads_type' AND status = 'verified' AND state = 'active' AND area = '$search_area';";
			$total_ads = mysqli_num_rows(mysqli_query($conn, $query));
...
<body>
	...
	<section class="filter_section">
		<div class="container">
			<div class="filtering">
				<form action="show_flat_ads.php" method="POST">
      ...
      <option value="Banani">Banani</option> -->
					...
					<input type="number" name="min_rent" id="min_rent" class="min_rent" placeholder="Min Rent" value="<?php echo $min_rent ?>" />
					<span style="margin: 0 5px;">To</span>
					<input type="number" name="max_rent" id="max_rent" class="max_rent" placeholder="Max Rent" value="<?php echo $max_rent ?>" /> -->
