...
<body>
 ...
 <section class="student_verify_section">
  <div class="container">
 ...
 <script>
  $(document).ready(function () {
   ...
   function viewAllDetails(event) {
    ...
    $('#right_section_information').load('../includes/load_admin_student_verify_details.inc.php', {
     'btn_click': allButtonValue
    });

    $('#left_section').load('../includes/load_admin_student_verify_details.inc.php', {
