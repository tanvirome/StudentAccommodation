...
$sqlUserCheck = "SELECT * FROM admin WHERE username = '$username'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 //  if ($err1 == "") {
 //   $sqlUserCheck = "SELECT username FROM admin WHERE username = '$username' and state = 'active';";
 ...
 //   } else {
 //    $sql = "UPDATE admin SET username='$username', status='unverified' WHERE user_id = '$user_id';";
 ...
 //  if ($err2 == "") {
 //   $sqlUserCheck = "SELECT email FROM admin WHERE email = '$user_email' and state = 'active';";
 ...
 //   } else {
 //    $sql = "UPDATE admin SET email='$user_email', status='unverified' WHERE user_id = '$user_id';";
 ...
 if (isset($_POST['update_info_button'])) {
  ...
  $sql = "UPDATE admin SET name='$user_full_name', religion='$user_religion', phone='$user_phone', nid='$user_nid', address='$user_address', gender='$user_gender', date_of_birth='$user_dob' WHERE username = '$username';";
 ...
 //  }
 //  if ($err3 = "") {
 //   $sqlUserCheck = "SELECT password FROM admin WHERE username = '$username';";
 //   $result = mysqli_query($conn, $sqlUserCheck);
 //   while ($row = mysqli_fetch_assoc($result1)) {
 //    $user_passwordInDB = $row['password'];
 //   }
 //   if (password_verify($user_password, $user_passwordInDB)) {
 //    $sql = "UPDATE admin SET state='deactive', status='unverified' WHERE username = '$username';";
...
<body>
 <?php echo after_login_admin_header("dashboard"); ?>
  ...
  <div class="container">
   <div class="side_navigation">
    ...
    <nav>
     <ul>
      <li id="profile_li">
       <a href="admin_profile.php" id="profile_a">Profile</a>
      </li>
      <li id="security_li">
       <a href="admin_security.php" id="security_a">Security</a>
      </li>
      <li class="current" id="information_li">
       <a href="admin_edit_information.php" id="information_a">Edit Information</a>
      </li>
     </ul>
    </nav>
   </div>
